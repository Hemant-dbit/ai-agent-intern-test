...
[Watch the 2-4 minute demo on Loom](https://www.loom.com/share/dc6e95ab11ef43bfaa3e98d0c86ee50e)
...
The same dependencies are declared in `pyproject.toml`; alternatively, install the project directly with:
...
_(Note: `.env` is ignored by git. No real credentials are committed.)_
...
_Open http://localhost:8000 in your web browser._
